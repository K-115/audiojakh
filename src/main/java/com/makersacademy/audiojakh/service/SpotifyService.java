...
////                    track.setArtistId((spotifyTrack.getArtists()[0].getId()));
////                }
////
...
////
////                if (spotifyTrack.getArtists().length > 0) {
////                    newTrack.setArtistId(spotifyTrack.getArtists()[0].getId());
////                }
////                if (spotifyTrack.getAlbum() != null) {
...
//
//            for (se.michaelthelin.spotify.model_objects.specification.Track spotifyTrack : trackPaging.getItems()) {
//                Track track = getTrack(spotifyTrack);
//                results.add(track);
//        return results;
//    }
//
//    private static Track getTrack(se.michaelthelin.spotify.model_objects.specification.Track spotifyTrack) {
//        Track track = new Track();
//        track.setSpotifyId(spotifyTrack.getId());
//        track.setName(spotifyTrack.getName());
//
//        if (spotifyTrack.getArtists().length > 0) {
//            track.setArtistId(spotifyTrack.getArtists()[0].getId());
//            track.setArtistName(spotifyTrack.getArtists()[0].getName());
//        }
//
//        if (spotifyTrack.getAlbum() != null) {
//            track.setAlbumId(spotifyTrack.getAlbum().getId());
...
//        } catch (Exception e) {
//            throw new RuntimeException("Failed to fetch artist profile from Spotify: " + artistId, e);
//        }
//    }
//
//    public AlbumSimplified[] getArtistDiscography(String artistId) {
//        authenticate();
...
//        }
//    }
//    public com.makersacademy.audiojakh.model.Artist getAndCacheArtist(String artistId) {
//        authenticate();
//            se.michaelthelin.spotify.model_objects.specification.Artist spotifyArtist =
//                    spotifyApi.getArtist(artistId).build().execute();
//
//            com.makersacademy.audiojakh.model.Artist localArtist = new com.makersacademy.audiojakh.model.Artist();
//            localArtist.setId(spotifyArtist.getId());
//            localArtist.setArtistName(spotifyArtist.getName());
//
//            if (spotifyArtist.getImages() != null && spotifyArtist.getImages().length > 0) {
//                localArtist.setArtistImage(spotifyArtist.getImages()[0].getUrl());
//            } else {
//                localArtist.setArtistImage("/images/default-artist.png");
//            }
//
//            return artistRepository.save(localArtist);
//        }
//    }
//
//
...
//                if (spotifyTrack.getArtists().length > 0) {
//                    newTrack.setArtistId(spotifyTrack.getArtists()[0].getId());
//                    newTrack.setArtistName(spotifyTrack.getArtists()[0].getName());
//                }
//                if (spotifyTrack.getAlbum() != null) {
//                    newTrack.setAlbumId(spotifyTrack.getAlbum().getId());
//                }
