...
//        List<String> favouriteArtistIds = favouriteArtistRepository.findArtistIdsByUserId(userId);
...
//
//        DTOProfileJoin profile = new DTOProfileJoin(user, favAlbums, favSongs, favouriteArtistIds, reviews, isOwnProfile, isFollowingThisUser, followers, following, reviewCount);
//
//        model.addAttribute("profile", profile);
//        model.addAttribute("isOwnProfile", isOwnProfile);
//        model.addAttribute("isFollowing", isFollowingThisUser);
//        List<se.michaelthelin.spotify.model_objects.specification.Artist> favouriteArtists = favouriteArtistIds.stream()
//                .map(id -> spotifyService.getArtist(id))
//                .toList();
//
//        model.addAttribute("favouriteArtists", favouriteArtists);
//
//
