...
INSERT INTO reviews (
    ...
    artist_name
      ...
      (
          'A beautiful, atmospheric track that feels incredibly timeless and cinematic.',
          2, 0, NOW(), 4,
      ...
      (
          'Catchy and fun, though it feels a bit dated compared to their newer production styles.',
          3, 0, NOW(), 3,
